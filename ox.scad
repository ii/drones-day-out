...
// Corner X,-Y
translate([0, -92, (block_type == "tile" ? block_height_ratio * block_height : 0)]) rotate([0, (block_type == "tile" ? 180 : 0), 90]) {
    block(
        width=block_width,
        length=block_length,
        height=block_height_ratio,
...
// Corner -X,Y
translate([-92, 0, (block_type == "tile" ? block_height_ratio * block_height : 0)]) rotate([0, (block_type == "tile" ? 180 : 0), 0]) {
    block(
        width=block_width,
        length=block_length,
        height=block_height_ratio,
...
//translate([75, 55, (block_type == "tile" ? block_height_ratio * block_height : 0)]) rotate([0, (block_type == "tile" ? 180 : 0), 35]) {
//    block(
//        width=block_width,
//        length=block_length,
//        height=block_height_ratio,
...
//    );
//}
//translate([-75, 55, (block_type == "tile" ? block_height_ratio * block_height : 0)]) rotate([0, (block_type == "tile" ? 180 : 0), 55]) {
//    block(
//        width=block_width,
//        length=block_length,
//        height=block_height_ratio,
